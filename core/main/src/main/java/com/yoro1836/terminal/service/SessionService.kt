package com.yoro1836.terminal.service
...
import com.yoro1836.terminal.backend.VsockTerminalBackend
import com.yoro1836.terminal.backend.avf.AvfVmManager
import com.yoro1836.terminal.backend.TerminalSessionBackend
import com.yoro1836.resources.drawables
...
class SessionService : Service() {
    ...
    var currentSession = mutableStateOf(Pair("tab1", WorkingMode.AVF))
    ...
    inner class SessionBinder : Binder() {
        ...
        /** Every tab is a rvshd/vsh shell over vsock; the VM outlives tabs. */
        fun createSession(
            id: String,
        ...
        /** Stops the shared Debian VM; tabs observe their sessions ending. */
        fun stopDebianVm() {
            AvfVmManager.stopDebian()
        }
        ...
        fun renameSession(oldId: String, newId: String): Boolean {
            ...
            val mode = sessionList.remove(oldId) ?: com.yoro1836.settings.Settings.working_Mode
    ...
    private companion object {
        const val ACTION_EXIT = "com.yoro1836.terminal.action.EXIT"
        const val ACTION_TOGGLE_WAKELOCK = "com.yoro1836.terminal.action.TOGGLE_WAKELOCK"
